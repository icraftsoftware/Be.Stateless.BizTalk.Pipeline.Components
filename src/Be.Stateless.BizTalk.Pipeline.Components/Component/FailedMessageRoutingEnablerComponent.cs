...
namespace Be.Stateless.BizTalk.Component
{
	...
	public class FailedMessageRoutingEnablerComponent : PipelineComponent
	{
		...
		public override string Description => "Enables routing of failed messages and prevents routing failure reports from being generated.";
		...
		{
			get => _microComponent.EnableFailedMessageRouting;
		...
		{
			get => _microComponent.SuppressRoutingFailureReport;
